...
export const Hero = ({
  ...
  return (
    <section
      className={`flex flex-col xl:flex-row justify-around gap-8 px-5 xl:px-0 my-24 ${bgStyle} w-full h-[694] py-12`}
    >
      <div className="flex flex-col justify-center space-y-8">
        ...
        {buttonTitle && (
          <button
            onClick={onClick}
            className="bg-[#5840B9] rounded-full px-6 py-3 text-gray-200 max-w-52"
          >
            {buttonTitle}
          </button>
        )}
