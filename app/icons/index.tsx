...
export function BarIcon(props: any) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function PlusIcon({ className }: IconsProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function ToggleIcon({ className }: IconsProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function FunnelIcon({ className }: IconsProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function FolderOpen(props: any) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function PaymentIcon(props: any) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function TasksIcon({ className }: IconsProps) {
  return (
    <svg
      width="15"
      height="15"
...
export function EllipsisVerticalIcon({ className }: IconsProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function TagIcon({ className }: IconsProps) {
  return (
    <svg
      xmlns="http://www.w3.org/2000/svg"
      fill="none"
...
export function LinkedIn({ className }: IconsProps) {
  return (
    <svg
      width="20"
      height="20"
